...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function render() {
            ...
            var options = ['Pickle', 'Patties', 'Cheese'];
...
var AddOption = function (_React$Component7) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            e.preventDefault();
            var option = e.target.elements.option.value.trim(); // trim white space from end of string
            if (option) {
                alert(option);
            }
        }
...
ReactDOM.render(React.createElement(IndecisionApp, null), document.getElementById('app_0'));
